...
class Player implements Runnable { // Quizá tengamos que añadir algo más aquí...
    ...
    public void drawMe(GraphicsContext gc) {
        Image image = null;
        if (direccion == "LEFT")
            image = new Image(getClass().getResourceAsStream("apicultor.png"));
        else
            image = new Image(getClass().getResourceAsStream("apicultorD.png"));
